...
constexpr auto qt_meta_stringdata_CLASSTodoWidgetENDCLASS = QtMocHelpers::stringData(
    "TodoWidget",
    "addTodo",
    "",
    "removeTodo",
...
void TodoWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->addTodo(); break;
        case 1: _t->removeTodo((*reinterpret_cast< std::add_pointer_t<QModelIndex>>(_a[1]))); break;
        case 2: _t->toggleCompleted((*reinterpret_cast< std::add_pointer_t<QModelIndex>>(_a[1]))); break;
